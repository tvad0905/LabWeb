...
public class NewsDAO {
    ...
    public ArrayList<News> getRecentArticle(int numberArticle) throws Exception {
        DBContext db = null;
        Connection con = null;
        ...
        try {
            ...
            while (rs.next()) {
                ...
                News article = new News(id, title, image, content, date, author);
    ...
    public News getArticleById(int id) throws Exception {
        DBContext db = null;
        Connection con = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        ...
        try {
            ...
            while (rs.next()) {
                ...
                return new News(id, title, image, content, date, author);
            }
    ...
    public ArrayList<News> getListAticleSearch(int numberArticleInPage, int pageCurrent, String keyword) throws Exception {
        DBContext db = null;
        Connection con = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
